...
(function () {
  ...
  /* ── Playlist Data ─────────────────────────────────── */
  const playlist = [
    { title: "A Void Reborn", src: "assets/audio/track1.mp3" },
    { title: "No Need for Panic", src: "assets/audio/track2.mp3" },
    { title: "Black Signal", src: "assets/audio/track3.mp3" },
    { title: "The Experiment", src: "assets/audio/track4.mp3" },
  ];
